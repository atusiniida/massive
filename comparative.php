...
<header  class="header">
  <ul class="nav nav-tabs">
    ...
    <li><a id="viewlink_f">&nbsp;Focused View&nbsp;</a></li>
    <li class="active"><a id="viewlink_c">&nbsp;Comparative View&nbsp;</a></li>
  </ul>
</header>
...
<body>
   <div class="container-fluid">
    <div class="row control-panel">
        ...
        <div class="container col-md-4">
            <div id="scalepicker" class="btn-group" data-toggle="buttons">
                <label class="btn btn-label bold">
                    scale
                </label>
                <div class="btn-group" role="group">
    ...
    <!-- <div id="prmpicker1" class="btn-group" data-toggle="buttons">
      ...
      <div id="prmpicker2" class="btn-group" data-toggle="buttons">
        <label class="btn btn-label">
        </label>
        <div class="btn-group" role="group">
          <div class="btn btn-default active dropdown-toggle" data-toggle="dropdown">
   ...
   <!--  <div class="row control-panel">
    ...
    <div class="row control-panel2">
        <div class="container col-md-6" id="prmpicker1">
            <label class="btn btn-label bold"></label>
            <span>&nbsp;&nbsp;&nbsp;</span>
            <input id="pp1Slider" data-slider-id='pp1Slider' type="text" />
        </div>
        <div class="container col-md-6" id="prmpicker2">
            <label class="btn btn-label bold"> </label>
            <span>&nbsp;&nbsp;&nbsp;</span>
            <input id="pp2Slider" data-slider-id='pp2Slider' type="text" />
        </div>
    ...
    <div class="row charts">
        <div class="container col-md-4">
            <div id="datasetpicker1" class="btn-group" data-toggle="buttons">
                <label class="btn btn-label bold">
                    <font color="red">statistic 1</font>
                </label>
                <div class="btn-group" role="group">
                    <div class="btn btn-default active dropdown-toggle" data-toggle="dropdown">
                        <span></span>
        ...
        <div class="container col-md-4">
            <div id="datasetpicker2" class="btn-group" data-toggle="buttons">
                <label class="btn btn-label bold">
                    <font color="orange">statistic 2</font>
                </label>
                <div class="btn-group" role="group">
                    <div class="btn btn-default active dropdown-toggle" data-toggle="dropdown">
                        <span></span>
        ...
        <div class="container col-md-4">
            ...
            <div id="datasetpicker3" class="btn-group" data-toggle="buttons">
                <label class="btn btn-label bold">
                    <font color="blue">statistic 3</font>
                </label>
                <div class="btn-group" role="group">
                    <div class="btn btn-default active dropdown-toggle" data-toggle="dropdown">
                        <span></span>
...
<script id="script"  src="./js/my2.js"
